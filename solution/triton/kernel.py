...
For the contest starter-kit, this entrypoint is packaged and executed by
FlashInfer-Bench. We use FlashInfer's optimized FP8 block-scale MoE API as a
correctness-first baseline, while keeping strict input validation to catch
mismatches early during local benchmarking.
"""
...
def kernel(
    ...
    """
    # Fixed geometry/constants from definition.
    hidden_size = 7168
    ...
    if seq_len > 8192:
        # Explicitly configure a higher tuning range for long traces.
    ...
    output = trtllm_fp8_block_scale_moe(
        ...
        routing_method_type=0,  # DeepSeek no-aux topk routing.
